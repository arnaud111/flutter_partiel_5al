...
class _ListPostState extends State<ListPost> {
  ...
  void _scrollListener() {
    ...
    if (_scrollController.position.extentAfter < 500 && postListBloc.state.status.status != StateStatusEnum.loading && postListBloc.state.status.status != StateStatusEnum.loadingNewItems) {
